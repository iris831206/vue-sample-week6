        ...
        <div class="input-group border mt-3">
          <div class="input-group-prepend">
            <button @click="qty > 1 && (qty--)" :disabled="qty <= 1"
              class="btn btn-outline-dark rounded-0 border-0 py-3" type="button" id="button-addon1">
              <i class="fas fa-minus"></i>
            </button>
          </div>
          <input readonly min="1" type="number" v-model="qty"
            class="form-control border-0 text-center my-auto shadow-none" placeholder=""
            aria-label="Example text with button addon" aria-describedby="button-addon1" value="1">
          <div class="input-group-append">
            <button @click="qty++" class="btn btn-outline-dark rounded-0 border-0 py-3" type="button"
              id="button-addon2">
