    ...
    <div class="row mt-5">
      <div class="col-md-3 mt-md-4">
        <div class="card border-0 mb-4 position-relative text-center">
          ...
          <div class="card-body p-0">
            <h4 class="mb-0 mt-4">芬芳氣息</h4>
            <div class="d-flex justify-content-center mt-3 ">
              <p class="card-text text-muted mb-0 w-75">
                讓香皂的馥郁芬芳和細緻泡沫溫柔包裹、深入滋養每一寸肌膚。
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-3 mt-md-4">
        <div class="card border-0 mb-4 position-relative text-center">
          ...
          <div class="card-body p-0">
            <h4 class="mb-0 mt-4">天然成分</h4>
            <div class="d-flex justify-content-center mt-3 ">
              <p class="card-text text-muted mb-0 w-75">
                選用天然、純淨配方，為您的肌膚注入活力，呈現健康光澤。
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-3 mt-md-4">
        <div class="card border-0 mb-4 position-relative text-center">
          <i style="font-size: 50px;" class="bi bi-chat-heart"></i>
          <div class="card-body p-0">
            <h4 class="mb-0 mt-4">呵護肌膚</h4>
            <div class="d-flex justify-content-center mt-3 ">
              <p class="card-text text-muted mb-0 w-75">
                溫和不刺激，讓肌膚在每一次沐浴中更加豐盈、柔軟。
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-3 mt-md-4">
        <div class="card border-0 mb-4 position-relative text-center">
          <i style="font-size: 50px;" class="bi bi-droplet"></i>
          <div class="card-body p-0">
            <h4 class="mb-0 mt-4">保濕滋潤</h4>
            <div class="d-flex justify-content-center mt-3 ">
              <p class="card-text text-muted mb-0 w-75">
                極致滋潤護理，保持水分平衡讓肌膚綻放明亮光彩。
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="d-flex align-items-center justify-content-between text-white py-4">
        ...
        <ul class="d-flex list-unstyled mb-0 h4">
          ...
          <li>
            <p @click="goUrl('https://www.instagram.com/')" class="text-white mx-3">
              <i class="fab fa-instagram"></i>
            </p>
          </li>
          <li>
            <p @click="goUrl('https://line.me/tw/')" class="text-white mx-3">
...
export default {
  ...
  methods: {
    ...
    getMail () {
      Swal.fire({
        title: '<strong>優惠碼<u>Matcha2024</u></strong>',
        icon: 'info',
        html: `
    恭喜您獲得 <b>優惠碼</b> ,
